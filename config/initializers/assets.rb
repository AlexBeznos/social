...
Rails.application.config.assets.precompile += %w(bootstrap.css gowifi.css gowifi_previews.css loyalty.css code_highlight.css landing_new.css landing_old.css)
